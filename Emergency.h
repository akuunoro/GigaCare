...
namespace HospitalMSystem {
	...
	/// <summary>
	/// Summary for Emergency
	/// </summary>
	public ref class Emergency : public System::Windows::Forms::Form
	{
	public:
		Emergency(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(Emergency::typeid));
			...
			this->btn_homeappmnt->Click += gcnew System::EventHandler(this, &Emergency::btn_homeappmnt_Click);
			// 
			// pnl_app
			// 
			...
			this->btn_doneapp->Click += gcnew System::EventHandler(this, &Emergency::btn_doneapp_Click);
			// 
			// label2
			// 
			...
			this->Name = L"Emergency";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Emergency";
			this->Load += gcnew System::EventHandler(this, &Emergency::Emergency_Load);
...
#pragma endregion
	private: System::Void btn_doneapp_Click(System::Object^ sender, System::EventArgs^ e) {
		Emergency2^ showem2 = gcnew Emergency2();
		showem2->Show();
		this->Hide();
	}
...
private: System::Void Emergency_Load(System::Object^ sender, System::EventArgs^ e) {
