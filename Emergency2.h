...
namespace HospitalMSystem {
	...
	/// <summary>
	/// Summary for Emergency2
	/// </summary>
	public ref class Emergency2 : public System::Windows::Forms::Form
	{
	public:
		Emergency2(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(Emergency2::typeid));
			...
			this->btn_homeappmnt->Click += gcnew System::EventHandler(this, &Emergency2::btn_homeappmnt_Click);
			// 
			// pnl_app
			// 
			...
			this->btn_doneapp->Click += gcnew System::EventHandler(this, &Emergency2::btn_doneapp_Click);
			// 
			// label2
			// 
			...
			this->lbl_genderapp->Size = System::Drawing::Size(283, 28);
			this->lbl_genderapp->TabIndex = 22;
			this->lbl_genderapp->Text = L"Accompanied by: Gender";
			// 
			// lbl_birthdayapp
			// 
			...
			this->lbl_birthdayapp->Size = System::Drawing::Size(308, 28);
			this->lbl_birthdayapp->TabIndex = 20;
			this->lbl_birthdayapp->Text = L"Accompanied by: Birthdate";
			// 
			// txt_mobilenumberapp
			// 
			...
			this->lbl_mobilenumberapp->Size = System::Drawing::Size(369, 28);
			this->lbl_mobilenumberapp->TabIndex = 18;
			this->lbl_mobilenumberapp->Text = L"Accompanied by: Mobile Number";
			// 
			// txt_homeaddressapp
			// 
			...
			this->lbl_homeaddressapp->Size = System::Drawing::Size(363, 28);
			this->lbl_homeaddressapp->TabIndex = 16;
			this->lbl_homeaddressapp->Text = L"Accompanied by: Home Address";
			// 
			// txt_lastnameapp
			// 
			...
			this->lbl_lastnameapp->Size = System::Drawing::Size(322, 28);
			this->lbl_lastnameapp->TabIndex = 14;
			this->lbl_lastnameapp->Text = L"Accompanied by: Last Name";
			// 
			// txt_middlenameapp
			// 
			...
			this->lbl_middlenameapp->Size = System::Drawing::Size(347, 28);
			this->lbl_middlenameapp->TabIndex = 12;
			this->lbl_middlenameapp->Text = L"Accompanied by: Middle Name";
			// 
			// panel2
			// 
			...
			this->lbl_firstnameapp->Size = System::Drawing::Size(325, 28);
			this->lbl_firstnameapp->TabIndex = 2;
			this->lbl_firstnameapp->Text = L"Accompanied by: First Name";
			// 
			// lbl_appmnt
			// 
			...
			this->Name = L"Emergency2";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Emergency2";
			this->Load += gcnew System::EventHandler(this, &Emergency2::Emergency2_Load);
...
#pragma endregion
	private: System::Void btn_doneapp_Click(System::Object^ sender, System::EventArgs^ e) {
		Emergency3^ showem3 = gcnew Emergency3();
		showem3->Show();
		this->Hide();
	}
...
private: System::Void Emergency2_Load(System::Object^ sender, System::EventArgs^ e) {
