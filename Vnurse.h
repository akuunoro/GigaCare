...
namespace HospitalMSystem {
	...
	/// Summary for Vnurse
	/// </summary>
	public ref class Vnurse : public System::Windows::Forms::Form
	{
	public:
		Form^ gobackvdr;
		Vnurse(void)
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(Vnurse::typeid));
			...
			this->btn_homeappmnt->Click += gcnew System::EventHandler(this, &Vnurse::btn_homeappmnt_Click);
			// 
			// pnl_signup
			// 
			...
			this->dataGridView1->Columns->AddRange(gcnew cli::array< System::Windows::Forms::DataGridViewColumn^  >(8) {
				this->lastname,
					this->firstname, this->middlename, this->homeaddress, this->phonenumber, this->birthdate, this->gender, this->department
			});
			...
			this->lbl_appmnt->Click += gcnew System::EventHandler(this, &Vnurse::lbl_appmnt_Click);
			// 
			// panel2
			// 
			this->panel2->BackColor = System::Drawing::Color::White;
			this->panel2->Location = System::Drawing::Point(131, 51);
			...
			this->Text = L"Vnurse";
			this->Load += gcnew System::EventHandler(this, &Vnurse::Vnurse_Load);
...
private: System::Void Vnurse_Load(System::Object^ sender, System::EventArgs^ e) {
