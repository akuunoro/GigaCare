...
namespace HospitalMSystem {
	...
	/// <summary>
	/// Summary for Vpatient
	/// </summary>
	public ref class Vpatient : public System::Windows::Forms::Form
	{
	public:
		Vpatient(void)
		{
	...
	private: System::Windows::Forms::DataGridViewTextBoxColumn^ assr;
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(Vpatient::typeid));
			...
			this->assn = (gcnew System::Windows::Forms::DataGridViewTextBoxColumn());
			this->assr = (gcnew System::Windows::Forms::DataGridViewTextBoxColumn());
			...
			this->btn_homeappmnt->Click += gcnew System::EventHandler(this, &Vpatient::btn_homeappmnt_Click);
			// 
			// pnl_signup
			// 
			...
			this->label1->Click += gcnew System::EventHandler(this, &Vpatient::label1_Click);
			// 
			// dataGridView1
			// 
			...
			this->dataGridView1->Columns->AddRange(gcnew cli::array< System::Windows::Forms::DataGridViewColumn^  >(13) {
				this->specialization,
					this->dori, this->lastname, this->firstname, this->middlename, this->homeaddress, this->phonenumber, this->birthdate, this->gender,
					this->assdr, this->assn, this->assr, this->dept
			});
			...
			// assn
			// 
			this->assn->HeaderText = L"Assigned Nurse";
			this->assn->MinimumWidth = 6;
			this->assn->Name = L"assn";
			this->assn->ReadOnly = true;
			this->assn->Width = 125;
			// 
			// assr
			// 
			this->assr->HeaderText = L"Assigned Room";
			this->assr->MinimumWidth = 6;
			this->assr->Name = L"assr";
			this->assr->ReadOnly = true;
			this->assr->Width = 125;
			// 
			// dept
			// 
			...
			this->Name = L"Vpatient";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Vpatient";
			this->Load += gcnew System::EventHandler(this, &Vpatient::Vpatient_Load);
...
private: System::Void label1_Click(System::Object^ sender, System::EventArgs^ e) {
	VPatient2^ showp2 = gcnew VPatient2(this);
	showp2->Show();
	Hide();
}
private: System::Void Vpatient_Load(System::Object^ sender, System::EventArgs^ e) {
